...
export const initialCostRows: CostInputRow[] = [
  ...
  },
  {
    ...
    mdPerSite: 30,
    years: [
      { bucket: 'Y1', sites: 6, cost: 141750 },
      { bucket: 'Y2', sites: 3, cost: 74418.75 },
      { bucket: 'Y3', sites: 1, cost: 26046.57 },
      { bucket: 'Y4', sites: 1, cost: 27348.9 },
      { bucket: 'Y5', sites: 1, cost: 28716.34 },
    ],
  },
  {
    id: 'CI-003',
    ...
    mdPerSite: 15,
    years: [
      { bucket: 'Y1', sites: 6, cost: 70875 },
      { bucket: 'Y2', sites: 4, cost: 49612.5 },
      { bucket: 'Y3', sites: 3, cost: 39069.85 },
      { bucket: 'Y4', sites: 3, cost: 41023.34 },
      { bucket: 'Y5', sites: 2, cost: 28716.34 },
    ],
  },
  {
    id: 'CI-004',
    ...
    mdPerSite: 25,
    years: [
      { bucket: 'Y1', sites: 1, cost: 57750 },
      { bucket: 'Y2', sites: 1, cost: 60637.5 },
      { bucket: 'Y3', sites: 1, cost: 63669.38 },
      { bucket: 'Y4', sites: 1, cost: 66852.85 },
      { bucket: 'Y5', sites: 1, cost: 70195.49 },
    ],
  },
  {
    id: 'CI-005',
